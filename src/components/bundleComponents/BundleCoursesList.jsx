...
import BundleCard from "../commonComponents/BundleCard.jsx";
    ...
    <div className="filter-parameter mt-3">
      <div className="container">
        <div className="popular-courses listing-page">
          <div className="row">
            {courseBundles?.map((course, i) => (
              <div key={i} className="col-lg-4 col-md-6 mt-5">
                <BundleCard course={course} />
              </div>
            ))}
          </div>
...
export default BundleCoursesList;
